 ...
 * 
 */
public class FillPick implements Serializable {
	...
	public FillPick(String orderId, Integer status) {
	...
	public FillPick(Long id, String userCode, String orderId, String outOrderId,
