 ...
 * 
 */
public class FillPickReg implements Serializable {
	...
	public FillPickReg(String orderId, Integer status) {
	...
	public FillPickReg(Long id, String userCode, String orderId, String outOrderId,
