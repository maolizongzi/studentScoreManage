...
<body class="page-header-fixed">
	<div style="padding-left: 20  0  0  0px ;  background-color: white;  height: 795px;  ">
					<form  id="form1" name="form1"  method="post"  action="${ctx}/user/toUserList.do">		
						<table class="table"style="margin-bottom: 0px;"  >
							<tbody>
								<tr>
									<td>用户名  <input type="text" name="userName" id="userName" value="${userDetial.userName}"  /> </td>
									<td>姓名  <input type="text" name="realName"  id="realName" value="${userDetial.realName}" /> </td>
									<td>公司名称  <input type="text" name="userCompanyName" id="userCompanyName" value="${userDetial.userCompanyName}"  /> </td>
									<td>部门名称  <input type="text" name="userDepartmentName" id="userDepartmentName" value="${userDetial.userDepartmentName}"  /> </td>
								</tr>
							</tbody>
						</table>
						<div class="title_add">
							<a href="#"  onclick="login();"   class="btn green" style="width: 70px;">查询</a>
							<a href="#" onclick="toAdd();"  class="btn blue" style="width: 70px;" ><i class="icon-plus"></i>创建用户</a>
						</div>
					</form>
								...
								<tbody>
									<c:forEach items="${pageView.items}"  var="page" varStatus="vs" >
											<tr>
												...
												<td>
													<a href="#" onclick="toEdit('${page.userId}');" >编辑</a>
													<a href="#" onclick="toDelete('${page.userId}');" >删除</a>
