...
<c:if test="${requestScope.msg != null}">
	...
	<div style="padding-left: 20px  0  0  0px ;  background-color: white;  height: 795px;  ">
					<form  id="form1" name="form1"  method="post"  action="${ctx}/userRate/queryDataByUserRegistration.do">		
						<table class="table table-bordered "style="margin-bottom: 0px;min-width:300px;"  >
							<tbody>
								<tr>
...
<script>
		function login(){
			var path = "${ctx}/userRate/queryDataByUserRegistration.do";  
		...
		function page(pageId){
			...
			var url="${ctx}/userRate/queryDataByUserRegistration.do?currentPage="+pageId+"&retentionRateFlag="+perId+"&sid="+sidId+"&startTime="+startTime+"&endTime="+endTime;
			location.href = url;
		}
